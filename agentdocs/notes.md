...
- [2026-03-31 RELEASE] **v1.0.0** — `context.json`: `product_version` **1.0.0**, `phase` **RELEASE**, `release` object; spec/design/tasks/requirements headers set to **v1.0**; see `agentdocs/RELEASE-1.0.md`.
