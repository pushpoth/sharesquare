...
> **Updated:** 2026-03-31 · **Total tasks:** 60 · **Done through Batch 12:** 38 tasks (see `context.json` `tasks_done`) · **App today:** Vite + PWA; Supabase Auth when real project URL; repos = Dexie unless `VITE_USE_SUPABASE_REPOS=true`.
